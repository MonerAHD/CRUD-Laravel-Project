    ...
    <div class="wrraper mx-4">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 mt-4">
                ...
                <input type="text" name="title" class="form-control" id="title" placeholder="New Title" value="{{ old('title') }}">
            </div>
            <div class="mb-3">
                <label for="description" class="form-label fs-4">Description</label>
                <textarea class="form-control" name="description" id="description" rows="3"
                    placeholder="Write a New Description Here">{{ old('description') }}</textarea>
            </div>
            <div class="mb-3">
